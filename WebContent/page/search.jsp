...
<div class="container mainContainer">
	   ...
	   <div class="row">
	   		<div class="col-lg-12" style="margin-top: 10px;">
	   			提示：最多展示最符合条件的10个用户、10条心情、10篇文章，本次检索耗时<span id="search-need-time" class="color-red">1000</span>.
	   		</div>
	   </div>
	   		...
	   		<div class="col-lg-12 col-sm-12" style="margin-top: 10px;">
	   			<div class="row" id="user-result-show">
	   				<!-- <div class="col-lg-1 col-sm-1">
    		 			<img class="img-circle" alt="" width="60" height="60" src="http://7xnv8i.com1.z0.glb.clouddn.com/leedane_app_upload_ec5da83b-4fd9-4924-ad04-3264dfc52a9843d8c1ec-95d3-4cc7-aa12-9379a2196df2_Screenshot_20161216-122520_01.png">
