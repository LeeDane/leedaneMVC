...
function getOneCategorys(){
	$.ajax({
		type : "post",
		data : {t: Math.random()},
		url : getBasePath() +"leedane/financial/category/one/getAll.action",
		dataType: 'json', 
		beforeSend:function(){
		},
...
function getTwoCategorys(){
	$.ajax({
		type : "post",
		data : {t: Math.random()},
		url : getBasePath() +"leedane/financial/category/two/getAll.action",
		dataType: 'json', 
		beforeSend:function(){
		},
		success : function(data) {
...
function getLocations(){
	$.ajax({
		type : "post",
		data : {t: Math.random()},
		url : getBasePath() +"leedane/financial/location/getAll.action",
		dataType: 'json', 
		beforeSend:function(){
		},
		success : function(data) {
...
function querySearch(params){
	...
	$.ajax({
		type : "post",
		data : params,
		url : getBasePath() +"leedane/financial/query.action",
		dataType: 'json', 
		beforeSend:function(){
			//显示列表
			isChart = true;
...
function queryPaging(params){
	...
	$.ajax({
		type : "post",
		data : getQueryPagingParaams(),
		url : getBasePath() +"leedane/financial/paging.action",
		dataType: 'json', 
		beforeSend:function(){
			//显示列表
			isChart = true;
...
function deleteFinancial(index){
	if(typeof(financials) != 'undefined' && financials.length > 0 && financials.length > index){
		...
		layer.confirm('您要删除该条记录吗？', {
			...
			$.ajax({
				type : "post",
				data : {fid: financials[index].id, t: Math.random()},
				url : getBasePath() +"leedane/financial/delete.action",
				dataType: 'json', 
				beforeSend:function(){
				},
				success : function(data) {
...
function doAddOrEdit(params){
	$.ajax({
		type : "post",
		data : params,
		url : getBasePath() +"leedane/financial/save.action",
		dataType: 'json', 
		beforeSend:function(){
		},
		success : function(data) {
